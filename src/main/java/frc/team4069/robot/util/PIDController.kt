...
class PIDController {
    ...
    private var ff: ((Double) -> Double)? = null
    ...
    fun withFeedforward(ff: (Double) -> Double) {
        this.ff = ff
    }

    fun calculate(input: Double): Double {
        val dt = deltaController.updateTime(Timer.getFPGATimestamp().second).second
